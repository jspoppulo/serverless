...
const API_URL = 'https://api.github.com/repos/jspoppulo/serverless/releases/';
const API_UPLOADS_URL = 'https://uploads.github.com/repos/jspoppulo/serverless/releases/';
